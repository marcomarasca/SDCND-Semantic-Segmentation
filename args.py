...
flags.DEFINE_integer('epochs', 80, "The number of epochs; default 50")
flags.DEFINE_integer('batch_size', 25, "The batch size; default 15")
...
flags.DEFINE_integer('early_stopping', 4, 'If provided will stop if the loss is not decreasing for the the given amount of epochs')
